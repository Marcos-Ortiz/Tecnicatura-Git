...
<br>
Aqui están todos los comandos de la primera clase: </br>

> Lo que vimos en la clase anterior:

<br> Abrimos la terminal de Git Bash en Window o la terminal de Ubuntu, tambien la terminal de Mac, y comenzamos con los siguientes comandos y creación de directorios</br>
...
Aqui están todos los comandos de la tercera clase: </br>
...
<br>TAREA -> AGREGAR LOS COMENTARIOS EN LOS COMANDOS, PARA SABER QUE PASA CON CADA UNO.</br>
